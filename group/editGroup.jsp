...
//System.out.print(group.getCode());
...
<td>
<input required type="text" name="code" value="<%=group.getCode()%>" size="30">
</td>
...
<td>
<input type="text" name="value" value="<%=group.getValue()%>" size="30">
</td>
...
<input type="hidden" name="page" value= "editGroup">
...
<button class="form-submit-button" onclick="window.location.href = 'groupDashboard.jsp'"> Close </button> 
